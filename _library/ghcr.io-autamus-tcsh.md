...
updated_at: "2021-04-20 01:10:51.842581"
container_url: ""
aliases:
 - "tcsh"
...
```bash
$ shpc install ghcr.io/autamus/tcsh:latest
```
...
```bash
$ module load ghcr.io/autamus/tcsh/latest
$ module help ghcr.io/autamus/tcsh/latest
```
