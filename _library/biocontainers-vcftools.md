...
updated_at: "2021-06-06 20:43:52.831512"
container_url: "https://hub.docker.com/r/biocontainers/vcftools"
aliases:
 - "vcftools"
...
$ podman run --it --rm --entrypoint /usr/bin/vcftools   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/bin/vcftools   -v ${PWD} -w ${PWD} <container> -c " $@"
```
