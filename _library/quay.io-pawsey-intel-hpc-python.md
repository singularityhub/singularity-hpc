...
updated_at: "2022-08-01 17:00:10.069587"
...
```bash
$ shpc install quay.io/pawsey/intel-hpc-python:2021.09
```
...
```bash
$ module load quay.io/pawsey/intel-hpc-python/2021.09
$ module help quay.io/pawsey/intel-hpc-python/2021.09
```
