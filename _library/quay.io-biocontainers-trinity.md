...
updated_at: "2021-06-22 03:45:47.789144"
...
```bash
$ shpc install quay.io/biocontainers/trinity:2.12.0
```
...
```bash
$ module load quay.io/biocontainers/trinity/2.12.0
$ module help quay.io/biocontainers/trinity/2.12.0
```
