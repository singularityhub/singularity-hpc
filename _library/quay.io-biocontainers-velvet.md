...
updated_at: "2021-07-20 19:26:43.494479"
...
```bash
$ shpc install quay.io/biocontainers/velvet:1.2.10
```
...
```bash
$ module load quay.io/biocontainers/velvet/1.2.10
$ module help quay.io/biocontainers/velvet/1.2.10
```
