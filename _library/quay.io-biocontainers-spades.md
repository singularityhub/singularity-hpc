...
updated_at: "2021-06-22 03:45:46.982881"
...
```bash
$ shpc install quay.io/biocontainers/spades:3.15.2
```
...
```bash
$ module load quay.io/biocontainers/spades/3.15.2
$ module help quay.io/biocontainers/spades/3.15.2
```
