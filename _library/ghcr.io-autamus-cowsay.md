...
updated_at: "2021-04-18 20:45:54.203799"
container_url: ""
aliases:
 - "cowsay"
...
```bash
$ shpc install ghcr.io/autamus/cowsay:latest
```
...
```bash
$ module load ghcr.io/autamus/cowsay/latest
$ module help ghcr.io/autamus/cowsay/latest
```
