...
updated_at: "2021-07-19 23:53:21.719543"
container_url: "https://hub.docker.com/r/biocontainers/bwa"
aliases:
 - "bwa"
...
$ podman run --it --rm --entrypoint /opt/conda/bin/bwa   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /opt/conda/bin/bwa   -v ${PWD} -w ${PWD} <container> -c " $@"
```
