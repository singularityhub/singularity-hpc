...
updated_at: "2021-06-20 01:56:36.420278"
...
$ podman run --it --rm --entrypoint /usr/bin/bedtools   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/bin/bedtools   -v ${PWD} -w ${PWD} <container> -c " $@"
```
