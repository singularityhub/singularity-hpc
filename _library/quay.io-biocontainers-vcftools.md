...
updated_at: "2021-06-23 01:49:36.240641"
...
```bash
$ shpc install quay.io/biocontainers/vcftools:0.1.16
```
...
```bash
$ module load quay.io/biocontainers/vcftools/0.1.16
$ module help quay.io/biocontainers/vcftools/0.1.16
```
