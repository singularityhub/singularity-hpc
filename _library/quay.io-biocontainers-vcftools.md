...
updated_at: "2021-07-28 00:01:07.743043"
...
```bash
$ shpc install quay.io/biocontainers/vcftools:0.1.15
```
...
```bash
$ module load quay.io/biocontainers/vcftools/0.1.15
$ module help quay.io/biocontainers/vcftools/0.1.15
```
