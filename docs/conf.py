...
latex_documents = [
    ("index", "shpc.tex", "shpc Documentation", "Vanessa Sochat", "manual"),
]
...
man_pages = [
    (
        "index",
        "Singularity Registry (HPC) Documentation",
        "Singularity Registry (HPC) Documentation",
        ["Vanessa Sochat"],
        1,
    )
...
texinfo_documents = [
    (
        ...
        ["Vanessa Sochat"],
        "shpc",
        "shpc is a tool for measuring and assessing change in packages.",
        "Miscellaneous",
    ),
]
